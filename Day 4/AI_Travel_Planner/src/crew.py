...
class DigitalLifeContentGenerationTeamCrew:
    ...
    @agent
    def digital_life_travel planning_specialist(self) -> Agent:
        
        return Agent(
            config=self.agents_config["digital_life_travel planning_specialist"],
    ...
    @task
    def travel planning_digital_life_topic(self) -> Task:
        return Task(
            config=self.tasks_config["travel planning_digital_life_topic"],
            markdown=False,
